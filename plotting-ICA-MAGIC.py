...
#GA
d1 = "20190320-154147-MAGIC-ICA-sorted-kurtosis.npy"
val1 = np.load("npData/" + d1)

d1 = "20190320-154340-MAGIC-PLAIN-sorted-kurtosis.npy"
val2 = np.load("npData/" + d1)
# vals = range(len(test_acc))

d1 = "20190320-154411-MAGIC-PCA-sorted-kurtosis.npy"
val3 = np.load("npData/" + d1)

d1 = "20190320-162541-MAGIC-ICA-2nd-kurtosis-axis.npy"
...
plt.bar(range(len(val1)), val1, color=my_blue, label='ICA', alpha=0.7)
plt.bar(range(len(val2)), val3, color=my_red, label='PCA', alpha=0.7)
plt.bar(range(len(val2)), val2, color=my_yellow, label='Untransformed', alpha=0.7)

plt.legend()

ax = plt.subplot(122)
ax.set_title("ICA Axis\nSecond Highest Kurtosis")
plt.xlabel("Attribute #")
plt.ylabel("Attribute value")
plt.bar(range(len(val4)), val4, color=my_blue, label='ICA')
...
plt.savefig("../tex/figures/MAGIC-ICA.pdf")
plt.show()
