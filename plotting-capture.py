...
#GA
d1 = "20190319-182721-MAGIC-KMeans-capture.npy"
val1 = np.load("npData/" + d1)

d1 = "20190319-182600-MAGIC-KMeans-purity.npy"
val3 = np.load("npData/" + d1)

d1 = "20190319-183251-MAGIC-EM-capture.npy"
val2 = np.load("npData/" + d1)

d1 = "20190319-183106-MAGIC-EM-purity.npy"
val4 = np.load("npData/" + d1)
# vals = range(len(test_acc))
...
plt.savefig("../tex/figures/MAGIC-capture.pdf")
plt.show()
