...
d1 = "20190320-210221-COVER-KMeans-ANOVA-1-7k-labels.npy"
val3 = np.load("npData/" + d1)

d1 = "20190320-210129-COVER-KMeans-ICA-15c-7k-labels.npy"
val4 = np.load("npData/" + d1)


d1 = "20190320-213929-COVER-EM-ANOVA-1c-7k-labels.npy"
val5 = np.load("npData/" + d1)

d1 = "20190320-213922-COVER-EM-ICA-33c-7k-labels.npy"
...
plt.savefig("../tex/figures/COVER-DIM-cluster-plots.pdf")
plt.show()
